...
LOCK_PATH = BASE_DIR / "irs.lock"
LOCK_MAX_AGE_SECONDS = 2 * 60 * 60

DISPLAY_TZ = os.environ.get("DISPLAY_TZ", "UTC")
TELEGRAM_DAILY_TZ = os.environ.get("TELEGRAM_DAILY_TZ", "Asia/Kuala_Lumpur")
TELEGRAM_DAILY_HOUR = int(os.environ.get("TELEGRAM_DAILY_HOUR", "8"))
TELEGRAM_DAILY_MINUTE = int(os.environ.get("TELEGRAM_DAILY_MINUTE", "45"))
TELEGRAM_SCHEDULER_POLL_SECONDS = int(os.environ.get("TELEGRAM_SCHEDULER_POLL_SECONDS", "30"))
TELEGRAM_SCHEDULER_STALE_LOCK_SECONDS = int(
    os.environ.get("TELEGRAM_SCHEDULER_STALE_LOCK_SECONDS", "900")
)
PROMPT_VERSION = "v3"
